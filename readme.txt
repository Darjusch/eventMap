...
Set some permanent marker in different color(done)
Set labels for some of them f.e. B for Bar, P for Park, C for Cafe, F for Food(done)
Replace Dog icon by watch icon, it will show when people are planning to go there.(done)
